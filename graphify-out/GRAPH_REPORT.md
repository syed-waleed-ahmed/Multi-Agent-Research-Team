...
Cohesion: 0.29
Nodes (6): _extract_token_usage(), Best-effort extraction of token-usage metrics from a ``CrewOutput``., _FakeOutput, _FakeUsage, test_extract_token_usage_from_model_dump(), test_extract_token_usage_none()
...
Cohesion: 0.5
Nodes (4): _extract_report(), Normalize a CrewAI ``CrewOutput`` (or any result) to report text., test_extract_report_empty_raises(), test_extract_report_prefers_raw()
